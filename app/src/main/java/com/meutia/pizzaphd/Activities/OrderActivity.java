...
public class OrderActivity implements Parcelable {
    ...
    private int calculate(){
        switch (type){
            case PEPPERONI_PIZZA: return satuan * 84000;
            case VEGGIE_PIZZA: return satuan * 84000;
            case SPLITZA_PIZZA: return satuan * 88000;
            case SPLITZA_CLASSIC_PIZZA: return satuan * 78000;
            case HAWAIIAN_PIZZA: return satuan * 74000;
            default: return 0;
        }
    }
